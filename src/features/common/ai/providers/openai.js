 ...
 */
function createLLM({ apiKey, model = 'gpt-4.1', temperature = 0.7, maxTokens = 8192, usePortkey = false, portkeyVirtualKey, ...config }) {
 ...
 */
function createStreamingLLM({ apiKey, model = 'gpt-4.1', temperature = 0.7, maxTokens = 8192, usePortkey = false, portkeyVirtualKey, ...config }) {
  return {
